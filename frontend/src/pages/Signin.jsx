...
const Signin=()=>{
    ...
    const handleSignIn = (e)=>{
        e.preventDefault()
        handleLogin(userFormData.email, userFormData.password)
    }
    return(
        <div className="flex items-center justify-center min-h-screen bg-[#140746]">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
                ...
                <p className="mt-4 text-sm text-center text-gray-600">
                    Don&apos;t have an account?&nbsp;&nbsp;<span onClick={()=>navigate("/register")} className="text-blue-400 underline cursor-pointer">Sign Up</span>
                </p>
